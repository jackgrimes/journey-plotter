...
base_layers_configs = {'roads': ['TQ_Road.shp', 'white'],
...
map_configs = {'overall': {'layers': ['roads',
                                      'water',
                                      'tidal_water',
                                      'building',
                                      'parks'
               ...
               'running_recents': {'layers': ['roads',
                                   ...
                                   'final_figure_output': 'no_final_output',
                                   'year_text': 'black'},
               'dark': {'layers': ['tidal_water'],
                        'which_journeys': 'all_journeys',
                        'plotting_or_not': dark,
                        'final_figure_output': 'final_output',
                        'year_text': 'dimgrey'},
               'dark_colours_by_time': {'layers': ['tidal_water'],
                                        'which_journeys': 'all_journeys',
               ...
               'overall_thick': {'layers': ['roads',
                                 ...
                                 'final_figure_output': 'final_output',
                                 'year_text': 'black'},
               'overall_shrinking': {'layers': ['roads',
                                                'water',
                                                'tidal_water',
                                                'building',
                                                'parks'
                                     ...
                                     'final_figure_output': 'final_output',
                                     'year_text': 'black'},
               'overall_bubbling_off': {'layers': ['roads',
                                                   'water',
                                                   'tidal_water',
                                                   'building',
                                                   'parks'
               ...
               'end_points': {'layers': ['roads',
                              ...
                              'final_figure_output': 'final_output',
                              'year_text': 'black'},
               'end_points_shrinking': {'layers': ['roads',
                                                   'water',
                                                   'tidal_water',
                                                   'building',
                                                   'parks'
